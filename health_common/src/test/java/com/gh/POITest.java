...
public class POITest {
    ...
    public void test1() throws Exception{
        ...
        XSSFWorkbook excel =new XSSFWorkbook(new FileInputStream(new File("/Users/gh/Desktop/新开始/workspace/poi.xlsx")));
    ...
    public void test3() throws Exception{
        ...
        FileOutputStream out=new FileOutputStream(new File("/Users/gh/Desktop/新开始/workspace/hello.xlsx"));
        excel.write(out);
        out.flush();
        excel.close();
    }
